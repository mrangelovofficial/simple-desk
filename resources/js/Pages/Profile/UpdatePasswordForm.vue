<template>
    <jet-form-section @submitted="updatePassword">
        ...
        <template #form>
            <div v-if="$page.props.user.changePassword" class="col-span-6 text-red-600 sm:col-span-4">You must change your password to continue</div>
        ...
        methods: {
            updatePassword() {
                this.form.put(route('user-password.update'), {
                    ...
                    onError: () => {
                        if (this.form.error('password')) {
                            this.form.reset('password', 'password_confirmation')
                            this.$refs.password.focus()
                        }

                        if (this.form.error('current_password')) {
